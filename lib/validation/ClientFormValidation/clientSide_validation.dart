class ClientsideValadation {
  ...
  String? validateClientAddress(String? value) {
    if (value == null || value.isEmpty) {
  ...
  String? validateClientPhoneNumber(String? value) {
  ...
  String? validateClientCNIC(String? value) {
